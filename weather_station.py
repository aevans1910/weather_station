...
class StatisticsDisplay:
    def __init__(self, weather_data):
        ...
        self.min = self.minWeather()
        self.max = self.maxWeather()
        self.average = self.averageWeather()
    ...
    def minWeather(self):
        ...
        for num in self.weather_data:
            if num < min:
                min = num
        return min

    def averageWeather(self):
        average = sum(self.weather_data) / len(self.weather_data)
        return average
    ...
    def displayWeather(self):
        print(f"Min weather: {self.min} Average weather: {self.average} Max weather: {self.max}")
...
class ForecastDisplay:
    ...
    def displayForecast(self):
        print(f"Temperature forecast: {self.forcast_temp} Humidity forecast: {self.forcast_humadity} Pressure forecast: {self.forcast_pressure}")
...
class WeatherStation:
    def main(self):
        ...
        forcast_display = ForecastDisplay(temperature, humidity, pressure)
